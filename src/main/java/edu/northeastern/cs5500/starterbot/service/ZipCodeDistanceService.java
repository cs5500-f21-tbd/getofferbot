...
// IMPORTANT NOTE: This is more like a calculator instead of a service and needs refactoring to make sure
// it conforms to the software engineering definition of a service. Nevertheless, it produces the distance,
...
public class ZipCodeDistanceService implements Service {
    ...
    public ZipCodeDistanceService(String thisZip, String otherZip) throws URISyntaxException, IOException {
