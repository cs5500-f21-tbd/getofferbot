...
// Class to test ScrapIndeed class

import java.sql.Timestamp;
import java.util.ArrayList;

public class TestScrapIndeed {
    public static void main(String[] args) {
        String loc = "Seattle, WA";
        String que = "";

        ArrayList<Job> jobs = new ScrapIndeed().Scrap(que, loc);
        if (jobs == null){
        ...
        for (Job job : jobs){
            ...
            if (location.getZipCode() == null) {
                System.out.println("Job Location: " + location.getCity() + ", " + location.getState());
            } else {
                System.out.println("Job Location: " + location.getCity() + ", " + location.getState() + " " + location.getZipCode().toString());
            }
